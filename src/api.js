...
export const fetchCountries = async () => {
  // Define una función asíncrona llamada fetchCountries.
  try {
    ...
    console.error("Error al buscar países:", error); // Muestra un mensaje de error en la consola.
...
export const getLocalCountries = () => {
  // Define una función para obtener la lista de países almacenados en localStorage.
...
export const saveLocalCountries = (countries) => {
  // Define una función para guardar una lista de países en localStorage.
